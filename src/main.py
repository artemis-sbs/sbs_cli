...
def fetch(repo, user, branch, folder):
    ...
    try:
        ...
        print(f"Could not unzip: {zip_file_path} {destination_directory}\n{e}")
        return
    ...
    try:
        ...
        print(f"Could not remove: {zip_file_path} {destination_directory}\n{e}")
    ...
    try:
        ...
        print(f"Could not load {deps_file}\n{e}")
